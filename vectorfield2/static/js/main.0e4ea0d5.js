...
/******/ 	__webpack_require__.p = "/canvas/vectorfield2/";
/******/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vectorfield2__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__registerServiceWorker__ = __webpack_require__(36);
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__vectorfield2__["a" /* default */],null),document.getElementById('root'));Object(__WEBPACK_IMPORTED_MODULE_4__registerServiceWorker__["a" /* default */])();
...
var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}// Kampyle of Eudoxus from https://generateme.wordpress.com/2016/04/24/drawing-vector-field/
// BETTER! UNIFORM SCALING [0, 1].
var min=Math.min,max=Math.max,abs=Math.abs,random=Math.random,cos=Math.cos,sin=Math.sin,tan=Math.tan,PI=Math.PI,sqrt=Math.sqrt;var SPACING_PX=80;var STEP_LENGTH_PX=10;var N_AGENTS_PER_SIDE=20;// Computed.
...
var aAvg=function aAvg(a,b){var pct=arguments.length>2&&arguments[2]!==undefined?arguments[2]:0.5;return __WEBPACK_IMPORTED_MODULE_4_angles___default.a.lerp(a,b,pct,__WEBPACK_IMPORTED_MODULE_4_angles___default.a.shortestDirection(a,b));};var VecField=function(_Component){_inherits(VecField,_Component);function VecField(){var _ref;var _temp,_this,_ret;_classCallCheck(this,VecField);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=VecField.__proto__||Object.getPrototypeOf(VecField)).call.apply(_ref,[this].concat(args))),_this),_this.agents=Array.from({length:N_AGENTS_PER_SIDE*N_AGENTS_PER_SIDE},function(_,i){var x=i%N_AGENTS_PER_SIDE*SPACING_PX;var y=Math.floor(i/N_AGENTS_PER_SIDE)*SPACING_PX;var node=new __WEBPACK_IMPORTED_MODULE_3__physics_Node__["a" /* default */](x,y);return node;}),_this.step=function(ctx,t){_this.agents=_this.agents.filter(function(_ref2,i1,agents){var x1=_ref2.x,y1=_ref2.y;if(!(x1>=0&&y1>=0&&x1<SIZE_PX&&y1<SIZE_PX))return false;return!agents.some(function(_ref3,i2){var x2=_ref3.x,y2=_ref3.y;return i1<i2&&abs(x1-x2)<1&&abs(y1-y2)<1;});});_this.agents.forEach(function(agent){var x=agent.x,y=agent.y;// Change the noise2D output range to [0, 360deg].
var noise=simplex.in2D(x/300,y/300);var ssss=sin(noise*2*PI);var sss=(ssss*3+ssss/abs(ssss)*2)/5;// Avoids the [-0.4, 0.4] range.
var sec=1/sss;var xt=sec;var yt=tan(noise)*sec;var x1=x+xt*STEP_LENGTH_PX;var y1=y-yt*STEP_LENGTH_PX;ctx.beginPath();ctx.moveTo(x,y);ctx.lineTo(x1,y1);ctx.strokeStyle='#fff';ctx.lineWidth=12;ctx.stroke();ctx.strokeStyle='#000';ctx.lineWidth=4;ctx.stroke();agent.x=x1;agent.y=y1;});},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(VecField,[{key:'render',value:function render(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Canvas__["a" /* default */],{height:SIZE_PX,step:this.step,width:SIZE_PX});}}]);return VecField;}(__WEBPACK_IMPORTED_MODULE_0_react__["Component"]);/* harmony default export */ __webpack_exports__["a"] = (VecField);
...
var publicUrl=new URL("/canvas/vectorfield2",window.location);if(publicUrl.origin!==window.location.origin){// Our service worker won't work if PUBLIC_URL is on a different origin
// from what our page is served on. This might happen if a CDN is used to
// serve assets; see https://github.com/facebookincubator/create-react-app/issues/2374
return;}window.addEventListener('load',function(){var swUrl="/canvas/vectorfield2"+'/service-worker.js';if(!isLocalhost){// Is not local host. Just register service worker
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.0e4ea0d5.js.map